...
| RESEARCH-PRACTICAL-001 | Complete current practical information for L001–L014 | `REVIEW` | **Codex** | — | `research/leiden-mvp-practical-info.md` — 14 structured records; temporary/unpublished facts kept as `RECHECK` |
