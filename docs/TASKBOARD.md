...
| RESEARCH-PRACTICAL-001 | Complete current practical information for L001–L014 | `IN PROGRESS` | **Codex** | — | `research/leiden-mvp-practical-info.md` — addresses, access, transport, visit timing and photography |
