...
| RESEARCH-HIDDEN-GEMS-001 | Verify current independent Leiden food, book and café places | `REVIEW` | **Codex** | — | `research/leiden-hidden-gems.md` — 16 verified places across every requested category; unverified stroopwafel vendor and restricted hofjes kept out of recommendations |
