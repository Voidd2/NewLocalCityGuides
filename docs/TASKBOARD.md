...
| RESEARCH-HIDDEN-GEMS-001 | Verify current independent Leiden food, book and café places | `IN PROGRESS` | **Codex** | — | `research/leiden-hidden-gems.md` — real operating places, hours, visitor fit and photo briefs |
