...
| COMPETITOR-PRICING-001 | Compare city-tour apps, Leiden operators and Dutch museum audio guides | `IN PROGRESS` | **Codex** | — | `research/competitor-pricing.md` — current prices, coverage, formats, languages and rating evidence |
