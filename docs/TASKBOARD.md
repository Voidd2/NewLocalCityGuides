...
| PHOTO-RESEARCH-001 | Photographer brief for website image placeholders | `IN PROGRESS` | **Codex** | — | `research/photography-shot-list.md` — audit found 36 actual codes, not 59 |
