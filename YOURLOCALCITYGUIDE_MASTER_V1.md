...
**2026-09-17 Codex update:** `PHOTO-RESEARCH-001` is in `REVIEW`. The repository contains
36 actual image placeholder codes, not 59; `10059` is the highest identifier. All 36 have a
production brief or named permission/content blocker in `research/photography-shot-list.md`.
