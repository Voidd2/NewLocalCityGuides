...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: lt("Waar vind je Schaapsvishandel en waarom ga je erheen?", "Where can you find Schaapsvishandel and why visit?", "Wo findest du Schaapsvishandel und warum lohnt sich ein Besuch?"), paragraphs: { nl: ["Op woensdag staat de viskar aan de Nieuwe Rijn, tegenover ROOS. Op zaterdag vind je de familie op de Vismarkt, tegenover De Waag. Buiten deze marktdagen kun je terecht bij de vaste winkel aan Herenstraat 48 in Leiden. Controleer voor vertrek de actuele openingstijden en eventuele wijzigingen rond feestdagen.", "Een bezoek past goed in een wandeling door de Leidse handelsgeschiedenis: je proeft bij een familiebedrijf dat sinds 1938 in de stad actief is, terwijl je tussen Vismarkt, Koornbrug en Nieuwe Rijn ziet waarom handel en water hier al eeuwen bij elkaar horen. Je kunt er onder meer terecht voor kibbeling, haring, verse of gebakken vis en visbroodjes."], en: ["On Wednesday, the fish cart is on Nieuwe Rijn, opposite ROOS. On Saturday, you will find the family on the Vismarkt, opposite De Waag. Outside these market days, visit the permanent shop at Herenstraat 48 in Leiden. Check current opening hours and possible holiday changes before travelling.", "A visit fits naturally into a walk through Leiden's trading history: you are eating at a family business active in the city since 1938, while the fish market, Koornbrug and Nieuwe Rijn show why water and trade have been connected here for centuries. The selection includes kibbeling, herring, fresh or fried fish and fish sandwiches."], de: ["Mittwochs steht der Fischwagen an der Nieuwe Rijn gegenüber von ROOS. Samstags findest du die Familie auf dem Vismarkt gegenüber De Waag. Außerhalb dieser Markttage kannst du das feste Geschäft in der Herenstraat 48 in Leiden besuchen. Prüfe vor der Anreise die aktuellen Öffnungszeiten und mögliche Änderungen an Feiertagen.", "Der Besuch passt gut zu einem Rundgang durch Leidens Handelsgeschichte: Du probierst Fisch bei einem Familienbetrieb, der seit 1938 in der Stadt aktiv ist, während Fischmarkt, Koornbrug und Nieuwe Rijn zeigen, warum Handel und Wasser hier seit Jahrhunderten zusammengehören. Zum Angebot gehören unter anderem Kibbeling, Hering, frischer oder gebratener Fisch und Fischbrötchen."] }, bullets: { nl: ["Woensdag: Nieuwe Rijn, tegenover ROOS", "Zaterdag: Vismarkt, tegenover De Waag", "Andere dagen: Herenstraat 48, Leiden"], en: ["Wednesday: Nieuwe Rijn, opposite ROOS", "Saturday: Vismarkt, opposite De Waag", "Other days: Herenstraat 48, Leiden"], de: ["Mittwoch: Nieuwe Rijn, gegenüber ROOS", "Samstag: Vismarkt, gegenüber De Waag", "Andere Tage: Herenstraat 48, Leiden"] } },
