    ...
    <div>
        ...
        <div className="grid md:grid-cols-2 gap-4">
          {routes.map((route) => (
            <Link
              ...
              className="group flex flex-col bg-white rounded-xl overflow-hidden border border-gray-100 hover:shadow-lg transition-shadow"
            >
      ...
      <section className="max-w-7xl mx-auto px-4 py-6">
        <div className="bg-orange-50 border-2 border-orange-200 rounded-2xl p-6 flex flex-col md:flex-row md:items-center gap-4">
          ...
          <Link
            href="/routes/custom"
            className="inline-flex items-center gap-2 bg-orange-500 hover:bg-orange-600 text-white font-semibold px-5 py-3 rounded-full transition-colors text-sm shrink-0"
          >
      ...
      <section className="bg-navy-800 text-white py-8">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <p className="text-hand text-orange-300 text-xl mb-2">Nieuwe avonturen volgen...</p>
          <h2 className="text-lg font-bold mb-2">Meer steden komen eraan!</h2>
          <p className="text-white/60 text-sm mb-4">
            We werken hard aan nieuwe bestemmingen. Welke stad wil je hier straks zien?
          </p>
