    ...
    <div>
        ...
        <div className="grid md:grid-cols-[1fr,380px] gap-8">
          <div>
            ...
            <div className="bg-white rounded-2xl border border-gray-200 p-6 mb-6">
              ...
              <p className="text-xs text-gray-500 mb-4">1 persoon &mdash; volledige toegang tot alle routes in Leiden</p>
      ...
      <section className="bg-gradient-to-br from-navy-800 to-navy-900 text-white py-8">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <p className="text-white/60 text-sm mb-4">Begin in Leiden en ontdek daarna andere prachtige steden.</p>
          ...
          <p className="text-sm text-white/50 italic">Binnenkort beschikbaar</p>
        </div>
      </section>
    </div>
  );
