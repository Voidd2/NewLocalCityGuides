            ...
            <nav className="max-w-7xl mx-auto px-4 py-6 space-y-1">
              {!isLoading && hasPaid ? (
                <>
                  ...
                  }>{t("nav.myRoutes")}</MenuLink>
                  <MenuLink href="/routes/custom" onClick={() => setMenuOpen(false)} icon={
                    <svg viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5">
                      <path d="M10.75 4.75a.75.75 0 00-1.5 0v4.5h-4.5a.75.75 0 000 1.5h4.5v4.5a.75.75 0 001.5 0v-4.5h4.5a.75.75 0 000-1.5h-4.5v-4.5z" />
                    </svg>
                  }>{t("nav.buildRoute")}</MenuLink>
                  <MenuLink href="/ontdek" onClick={() => setMenuOpen(false)} icon={
                    <svg viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5">
                      <path fillRule="evenodd" d="M9 3.5a5.5 5.5 0 100 11 5.5 5.5 0 000-11zM2 9a7 7 0 1112.452 4.391l3.328 3.329a.75.75 0 11-1.06 1.06l-3.329-3.328A7 7 0 012 9z" clipRule="evenodd" />
                    </svg>
                  }>{t("nav.ontdek")}</MenuLink>
                  ...
                  <MenuLink href="/about" onClick={() => setMenuOpen(false)}>{t("nav.aboutCity")}</MenuLink>
                  <div className="pt-3 mt-3 border-t border-white/10">
                    <MenuLink href="/account" onClick={() => setMenuOpen(false)} highlight>
                      {t("nav.myAccount")}
                    </MenuLink>
                  </div>
                </>
