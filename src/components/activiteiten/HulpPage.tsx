      ...
      <div>
        <section className="bg-gradient-to-b from-navy-800 to-navy-900 text-white px-4 py-12 pb-16">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <h1 className="text-2xl md:text-3xl font-bold mb-3">Bedankt, {formData.name}!</h1>
            <p className="text-white/70 text-sm leading-relaxed mb-2">
              We hebben je aanvraag ontvangen en gaan er direct mee aan de slag.
            </p>
            <p className="text-white/70 text-sm leading-relaxed">
              Je ontvangt binnen 24 uur een persoonlijk voorstel op <span className="text-orange-300 font-medium">{formData.email}</span>.
            </p>
          </div>
        </section>
    ...
    <div>
      <section className="relative overflow-hidden">
        <div className="bg-gradient-to-b from-navy-800 to-navy-900 text-white px-4 py-10 pb-16">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h1 className="text-2xl md:text-3xl font-bold mb-3">Wij plannen jouw perfecte dag</h1>
            <p className="text-white/70 text-sm leading-relaxed max-w-xl mx-auto">
              Geen stress, geen gedoe. Vertel ons wat je leuk vindt en wij regelen alles voor je - van begin tot eind.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-4xl mx-auto px-4 -mt-3 mb-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="bg-white rounded-2xl border border-gray-200 p-5 text-center shadow-sm">
            ...
            <h3 className="font-bold text-navy-800 text-sm mb-1">Leiden ontdekken</h3>
            <p className="text-xs text-gray-500 leading-relaxed">
              De mooiste routes, verborgen plekjes en lokale tips voor een onvergetelijke dag in Leiden.
            </p>
          </div>
          <div className="bg-white rounded-2xl border border-gray-200 p-5 text-center shadow-sm">
            ...
            <h3 className="font-bold text-navy-800 text-sm mb-1">Dagje Amsterdam</h3>
            <p className="text-xs text-gray-500 leading-relaxed">
              Een dagtrip naar Amsterdam of een andere stad? Wij regelen vervoer, tickets en de beste plekken.
            </p>
          </div>
          <div className="bg-white rounded-2xl border border-gray-200 p-5 text-center shadow-sm">
            ...
            <h3 className="font-bold text-navy-800 text-sm mb-1">Verblijf regelen</h3>
            <p className="text-xs text-gray-500 leading-relaxed">
              Meerdere dagen? Wij vinden het perfecte hotel of appartement voor jouw budget en wensen.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-3xl mx-auto px-4 mb-10">
        <div className="bg-gradient-to-br from-orange-50 to-amber-50 border border-orange-200 rounded-2xl p-6 md:p-8">
          <h2 className="text-lg font-bold text-navy-800 mb-2">Hoe werkt het?</h2>
          ...
          <div className="space-y-5">
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="font-bold text-navy-800 text-sm mb-0.5">Vertel ons je wensen</h3>
                <p className="text-xs text-gray-500 leading-relaxed">
                  Vul het formulier hieronder in. Wil je Leiden ontdekken? Een dagje Amsterdam? Iets met de kids? Of weet je het nog niet precies? Geen probleem - we denken graag met je mee.
                </p>
              </div>
            </div>
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="font-bold text-navy-800 text-sm mb-0.5">Wij maken een plan op maat</h3>
                <p className="text-xs text-gray-500 leading-relaxed">
                  Binnen 24 uur ontvang je een persoonlijk voorstel. Met routes, activiteiten, restaurants, vervoer en eventueel verblijf - alles afgestemd op jouw groep en budget.
                </p>
              </div>
            </div>
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="font-bold text-navy-800 text-sm mb-0.5">Geniet zonder zorgen</h3>
                <p className="text-xs text-gray-500 leading-relaxed">
                  Wij boeken alles voor je en je ontvangt een compleet dagprogramma. Tijdens je bezoek kun je ons altijd bereiken voor vragen of wijzigingen.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="max-w-3xl mx-auto px-4 mb-10">
        <h2 className="text-lg font-bold text-navy-800 mb-2">Waar kunnen we je mee helpen?</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          <HelpCard
            ...
            title="Rondvaarten en tours"
            description="Grachtenrondvaarten, stadswandelingen, fietstours en meer. Wij kennen de beste gidsen en routes in Leiden."
          />
          <HelpCard
            icon={
              <svg viewBox="0 0 24 24" fill="none" className="w-5 h-5" stroke="currentColor" strokeWidth="1.5">
            ...
            title="Dagje Amsterdam"
            description="Wil je Amsterdam bezoeken? Wij regelen het vervoer, plannen de perfecte route en boeken je tickets voor musea en attracties."
          />
          <HelpCard
            icon={
              <svg viewBox="0 0 24 24" fill="none" className="w-5 h-5" stroke="currentColor" strokeWidth="1.5">
            ...
            description="Van treintickets tot privevervoer. Wij zorgen dat je comfortabel op je bestemming komt, waar dat ook is."
          />
          <HelpCard
            icon={
              <svg viewBox="0 0 24 24" fill="none" className="w-5 h-5" stroke="currentColor" strokeWidth="1.5">
            ...
            title="Verblijf boeken"
            description="Hotel, B&B of appartement - wij vinden de beste optie voor jouw budget. Van gezellig tot luxe, in Leiden of daarbuiten."
          />
          <HelpCard
            icon={
              <svg viewBox="0 0 24 24" fill="none" className="w-5 h-5" stroke="currentColor" strokeWidth="1.5">
            ...
            title="Activiteiten voor gezinnen"
            description="Met kinderen op pad? Wij kennen de leukste plekken en activiteiten voor het hele gezin. Van musea tot speeltuinen."
          />
          <HelpCard
            icon={
              <svg viewBox="0 0 24 24" fill="none" className="w-5 h-5" stroke="currentColor" strokeWidth="1.5">
            ...
            title="Andere steden en regio"
            description="Den Haag, Rotterdam, Haarlem of de Keukenhof - wij plannen dagtrips naar elke stad of attractie in de regio."
          />
          <HelpCard
            icon={
              <svg viewBox="0 0 24 24" fill="none" className="w-5 h-5" stroke="currentColor" strokeWidth="1.5">
            ...
            title="Musea en cultuur"
            description="Tickets voor musea, tentoonstellingen en culturele evenementen. Wij weten wat er speelt en regelen je toegang."
          />
          <HelpCard
            icon={
              <svg viewBox="0 0 24 24" fill="none" className="w-5 h-5" stroke="currentColor" strokeWidth="1.5">
            ...
            title="Compleet dagprogramma"
            description="Geen zin om zelf te plannen? Wij maken een compleet programma van ochtend tot avond, inclusief lunch en diner."
          />
        </div>
      </section>
        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-6 md:p-8 shadow-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="block text-xs font-semibold text-navy-800 mb-1.5">Naam *</label>
                <input
                  type="text"
                  required
                  value={formData.name}
              ...
              <div>
                <label className="block text-xs font-semibold text-navy-800 mb-1.5">E-mailadres *</label>
                <input
                  type="email"
                  required
            ...
            <div>
              <label className="block text-xs font-semibold text-navy-800 mb-1.5">Welke dagen? *</label>
              <input
                type="text"
                required
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                <label className="block text-xs font-semibold text-navy-800 mb-1.5">Volwassenen (18+)</label>
                <select
              ...
              <div>
                <label className="block text-xs font-semibold text-navy-800 mb-1.5">Kinderen (0-12)</label>
                <select
              ...
              <div>
                <label className="block text-xs font-semibold text-navy-800 mb-1.5">Groepsgrootte totaal</label>
                <input
                  type="text"
            ...
            <div>
              <label className="block text-xs font-semibold text-navy-800 mb-1.5">Waar heb je interesse in?</label>
              <select
            ...
            <div>
              <label className="block text-xs font-semibold text-navy-800 mb-1.5">Vertel ons meer (optioneel)</label>
              <textarea
      ...
      <section className="bg-navy-800 text-white py-10 mb-16">
        <div className="max-w-3xl mx-auto px-4 text-center">
          <p className="text-hand text-orange-300 text-xl mb-2">Waarom wij?</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-left mb-8">
            <div className="bg-white/5 rounded-xl p-4 border border-white/10">
              <div className="flex items-center gap-2 mb-2">
                ...
                <h3 className="font-semibold text-sm">Echte lokale expertise</h3>
              </div>
              <p className="text-xs text-white/60 leading-relaxed">
                Wij zijn geboren en getogen in Leiden. We kennen elk straatje, elke verborgen plek en de beste restaurants.
              </p>
            </div>
            <div className="bg-white/5 rounded-xl p-4 border border-white/10">
              <div className="flex items-center gap-2 mb-2">
                ...
                <h3 className="font-semibold text-sm">Volledig op maat</h3>
              </div>
              <p className="text-xs text-white/60 leading-relaxed">
                Geen standaard touristen-routes. Elk plan is uniek en afgestemd op jouw wensen, budget en groep.
              </p>
            </div>
            <div className="bg-white/5 rounded-xl p-4 border border-white/10">
              <div className="flex items-center gap-2 mb-2">
                ...
                <h3 className="font-semibold text-sm">Alles geregeld</h3>
              </div>
              <p className="text-xs text-white/60 leading-relaxed">
                Van vervoer tot verblijf, van tickets tot restaurants. Jij hoeft alleen maar te genieten.
              </p>
            </div>
            <div className="bg-white/5 rounded-xl p-4 border border-white/10">
              <div className="flex items-center gap-2 mb-2">
                ...
                <h3 className="font-semibold text-sm">Altijd bereikbaar</h3>
              </div>
              <p className="text-xs text-white/60 leading-relaxed">
                Tijdens je bezoek kun je ons altijd bereiken. Planwijziging? Restaurant vol? Wij lossen het op.
              </p>
            </div>
          </div>
