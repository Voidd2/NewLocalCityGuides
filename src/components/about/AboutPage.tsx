    ...
    <div>
      <section className="bg-gradient-to-b from-navy-800 to-navy-900 text-white px-4 py-12">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-white/70 text-base max-w-lg mx-auto">
            Een stad vol geschiedenis, wetenschap en verhalen. Ontdek wat Leiden zo bijzonder maakt.
          </p>
        </div>
      </section>

      <section className="max-w-3xl mx-auto px-4 py-8">
        <Accordion title="Geschiedenis in het kort">
          <p className="mb-3">
            Leiden is een van de oudste steden van Nederland, gelegen aan de Oude Rijn. De stad heeft een rijke historie die teruggaat tot de Romeinse tijd.
          </p>
          <p className="mb-3">
            Leiden is wereldberoemd als universiteitsstad (de oudste universiteit van Nederland, opgericht in 1575 als dank voor het dappere verzet tijdens het Spaanse beleg), als geboortestad van Rembrandt, en als thuishaven van de Pilgrim Fathers voordat zij naar Amerika vertrokken.
          </p>
          <p>
            Vandaag de dag is Leiden een bruisende stad met een compact, historisch centrum vol grachten, hofjes, musea en verhalen op elke straathoek.
          </p>
        </Accordion>

        <Accordion title="Praktische tips">
          <ul className="space-y-2">
            <li className="flex items-start gap-2">
              ...
              <span>Leiden is het best te verkennen te voet of per fiets. Het centrum is compact en grotendeels autovrij.</span>
            </li>
            <li className="flex items-start gap-2">
              <svg viewBox="0 0 20 20" fill="currentColor" className="w-4 h-4 text-orange-500 mt-0.5 shrink-0"><path fillRule="evenodd" d="M16.704 4.153a.75.75 0 01.143 1.052l-8 10.5a.75.75 0 01-1.127.075l-4.5-4.5a.75.75 0 011.06-1.06l3.894 3.893 7.48-9.817a.75.75 0 011.05-.143z" clipRule="evenodd" /></svg>
              <span>Op woensdag en zaterdag is er markt op de Nieuwe Rijn en Botermarkt. De perfecte combinatie met de Centrum Route.</span>
            </li>
            <li className="flex items-start gap-2">
              <svg viewBox="0 0 20 20" fill="currentColor" className="w-4 h-4 text-orange-500 mt-0.5 shrink-0"><path fillRule="evenodd" d="M16.704 4.153a.75.75 0 01.143 1.052l-8 10.5a.75.75 0 01-1.127.075l-4.5-4.5a.75.75 0 011.06-1.06l3.894 3.893 7.48-9.817a.75.75 0 011.05-.143z" clipRule="evenodd" /></svg>
              <span>Leiden Centraal station is goed verbonden met de rest van Nederland. Vanaf het station loop je in 10 minuten naar het centrum.</span>
            </li>
            <li className="flex items-start gap-2">
              <svg viewBox="0 0 20 20" fill="currentColor" className="w-4 h-4 text-orange-500 mt-0.5 shrink-0"><path fillRule="evenodd" d="M16.704 4.153a.75.75 0 01.143 1.052l-8 10.5a.75.75 0 01-1.127.075l-4.5-4.5a.75.75 0 011.06-1.06l3.894 3.893 7.48-9.817a.75.75 0 011.05-.143z" clipRule="evenodd" /></svg>
              <span>De meeste bezienswaardigheden zijn gratis toegankelijk. Alleen musea vragen entree.</span>
            </li>
          </ul>
        </Accordion>

        <Accordion title="Veelgestelde vragen">
          <div className="space-y-4">
            <div>
              <p className="font-medium text-navy-800 mb-1">Hoe werkt YourLocalCityGuide?</p>
              <p>Na aankoop van het Leiden pakket krijg je toegang tot alle routes en locaties. Op elke locatie kun je interactieve video&apos;s bekijken, verhalen lezen en de stad ontdekken op jouw eigen tempo.</p>
            </div>
            <div>
              <p className="font-medium text-navy-800 mb-1">Hoelang heb ik toegang?</p>
              <p>Je hebt levenslange toegang tot het Leiden pakket. Alle toekomstige routes en updates zijn inbegrepen.</p>
            </div>
            <div>
              <p className="font-medium text-navy-800 mb-1">Kan ik de routes ook offline gebruiken?</p>
              <p>De routes en verhalen zijn online beschikbaar. Een internetverbinding is nodig om de video&apos;s en content te laden.</p>
            </div>
            <div>
              <p className="font-medium text-navy-800 mb-1">Is het geschikt voor kinderen?</p>
              <p>Alle routes zijn kindvriendelijk. De interactieve video&apos;s zijn ook voor kinderen leuk en leerzaam.</p>
            </div>
          </div>
        </Accordion>
      </section>
      ...
      <section className="bg-navy-800 text-white py-10">
        <div className="max-w-3xl mx-auto px-4 text-center">
          <p className="text-hand text-orange-300 text-2xl mb-2 -rotate-1">Same streets.</p>
          <h2 className="text-2xl font-bold mb-3">A richer story.</h2>
